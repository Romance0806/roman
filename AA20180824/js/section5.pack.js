(function (a) {
  ArcheAge.namespace("Game.Section5");
  ArcheAge.Game.Section5 = Class.extend({
    init: function () {
    ...
    characterResize: function () {
      ...
      this.section = a("[data-id=section5]");
      a(".armor").width(c);
...
/*$(document).ready(function(){
  $("ul.dragon li").click(function(){
    $(".inner img").css('display','none');
  });
});*/
